...
export const getEvent = (state) => state.forms.news.data
...
export const clearNews = createAction(CLEAR_NEWS)
...
function create(){
	...
	return reducer(intialState, [CHANGE_NEWS, CLEAR_NEWS, NEWS_VALIDATE_FAIL])
}
